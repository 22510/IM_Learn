...
import com.qehing.client.console.command.ConsoleCommand;
...
public class LoginMenuState implements State, ConsoleCommand {
    ...
    private LoginMenuState() {
        ...
        stateMap.put("back", MainMenuState.INSTANCE);
    ...
    public void exec(Scanner scanner, Channel channel) {
        ...
        SqlSessionFactory sqlSessionFactory = MyBatisInit.getSessionFactory();
